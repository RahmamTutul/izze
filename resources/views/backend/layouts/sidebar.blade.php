...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('admin/all-users')) ? 'active' : '' }}" data-toggle="collapse" href="#auth" aria-controls="auth">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('admin/menus/index')) ? 'active' : '' }}" href="{{url('admin/menus/index')}}">
          <i class="mdi mdi-view-headline menu-icon"></i>
          <span class="menu-title">Menu Bar</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (request()->is('admin/hero/index')) ? 'active' : '' }}" href="{{url('admin/hero/index')}}">
          <i class="mdi mdi-view-headline menu-icon"></i>
